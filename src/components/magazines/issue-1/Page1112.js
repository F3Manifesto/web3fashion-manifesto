...
const Page1112 = () => (
  <div className={styles.wrapper}>
    ...
    <h2>This wonderful world is filled with things with far more power than us. But if you’re smart about where you are, when you show up and which devices you know how to ride, you can catch a wave and go places.</h2>
    <h3>Yet, yes, you need ammunition, not a ride.</h3>
