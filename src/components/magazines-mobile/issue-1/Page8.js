...
const Page8 = () => {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <h2>
        <p>
          “Because here is a secret that only fractured souls know: We decide our stories.
          <br/><br/>
      ...
      <h5>
        <a
          ...
          href="https://github.com/F3Manifesto/ccomaterials/tree/main/icoinedweb3fashion"
          target="_blank"
          rel="noreferrer"
        >
